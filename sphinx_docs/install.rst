...
* `SageMath <https://www.sagemath.org>`_ version 9.1 (Release Date: 2020-05-20) or higher.
...
`PyNormaliz <https://doc.sagemath.org/html/en/reference/discrete_geometry/sage/geometry/polyhedron/backend_normaliz.html>`_ package is optional and used for sending an affine semigroup to the polyhedron generated by "saturation" of the given affine semigroup. To install this, compile `Normaliz <https://github.com/Normaliz/Normaliz>`_ by downloading its released version of source code and type

.. code-block:: shell

   ./install_normaliz_with_eantic.sh

on folders containing the source code. Then, you can install pynormaliz via

.. code-block:: shell

   sage -python -m pip install pynormaliz
